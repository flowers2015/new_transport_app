...
const stageOptions: { value: StageKey; label: string; helper: string }[] = [
    {
        value: 'stage1',
        label: 'مرحله اول — خیلی‌دور (دور و نزدیکِ نرفته)',
        helper:
            'فقط بارهای خیلی‌دور، برای همه نفراتی که در دوره جاری (۲۶–۲۵ شمسی) خیلی‌دور نرفته‌اند — چه نوبت دور، چه نوبت نزدیک.',
    },
    {
        value: 'stage2',
        label: 'مرحله دوم — بارهای باقی‌مانده',
        helper: 'همان قوانین تابلو اعلام بار و بله — از ابتدای نوبت دور تا انتهای نوبت نزدیک.',
    },
];
