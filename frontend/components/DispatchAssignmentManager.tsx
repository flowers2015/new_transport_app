...
const stageOptions: { value: StageKey; label: string; helper: string }[] = [
    { value: 'stage1', label: 'مرحله اول - مسیرهای خیلی دور', helper: 'رانندگانی که در ۲۶ روز اخیر مسیر دور داشته‌اند در این مرحله مسدود هستند.' },
    { value: 'stage2', label: 'مرحله دوم - سایر مسیرها', helper: 'تمام نوبت‌های باقی‌مانده و اعلام بارهای آزاد نمایش داده می‌شوند.' },
];
