...
const TransportFinancePaidInvoices: React.FC<TransportFinancePaidInvoicesProps> = ({ currentUser }) => {
        ...
        const blocksHTML = blocks.map((block, blockIdx) => {
            ...
            const tableRowsHTML = block.rows.map((row) => {
                if (row.kind === 'meta') {
                    ...
                    return `
                        <tr style="direction: rtl; unicode-bidi: isolate;">
                            <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: right; font-family: 'Vazir', 'Tahoma', sans-serif; font-weight: 600;">${row.label || ''}</td>
                            <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: right; font-family: 'Vazir', 'Tahoma', sans-serif;">${row.value || ''}</td>
                            <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: right; white-space: nowrap; font-family: 'Vazir', 'Tahoma', sans-serif;"></td>
                            <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: right; white-space: nowrap; font-family: 'Vazir', 'Tahoma', sans-serif;"></td>
                        </tr>
                    `;
                } else if (row.kind === 'categoryHeader') {
                    ...
                    return `
                        <tr style="direction: rtl; unicode-bidi: isolate;">
                            <td colspan="4" style="font-weight: bold; background-color: #f3f4f6; text-align: center; padding: 16px 16px 42px 16px; border: 1px solid #000; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; font-family: 'Vazir', 'Tahoma', sans-serif;">${row.category || ''}</td>
                        </tr>
                    `;
                } else if (row.kind === 'cost') {
                    ...
                    return `
                        <tr style="direction: rtl; unicode-bidi: isolate;">
                            <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: right; font-family: 'Vazir', 'Tahoma', sans-serif; font-weight: 600;">${row.category || ''}</td>
                            <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: right; font-family: 'Vazir', 'Tahoma', sans-serif; white-space: normal; word-wrap: break-word;">${row.description || ''}</td>
                            <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: right; white-space: nowrap; font-family: 'Vazir', 'Tahoma', sans-serif;">${unitAmountStr}</td>
                            <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: right; white-space: nowrap; font-family: 'Vazir', 'Tahoma', sans-serif;">${totalAmountStr}</td>
                        </tr>
                    `;
                }
                return '';
            ...
            const totalRowHTML = `
                <tr style="direction: rtl; unicode-bidi: isolate; background-color: #3b82f6;">
                    <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: center; font-weight: bold; color: #ffffff; font-family: 'Vazir', 'Tahoma', sans-serif;">جمع کل</td>
                    <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: center; font-weight: bold; color: #ffffff; font-family: 'Vazir', 'Tahoma', sans-serif;">-</td>
                    <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: center; font-weight: bold; color: #ffffff; font-family: 'Vazir', 'Tahoma', sans-serif;">-</td>
                    <td style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; direction: rtl; unicode-bidi: isolate; vertical-align: middle; text-align: right; white-space: nowrap; font-weight: bold; color: #ffffff; font-family: 'Vazir', 'Tahoma', sans-serif;">${totalAmount.toLocaleString('fa-IR')}</td>
                </tr>
            `;
                ...
                <div style="width: 100%; display: block; direction: rtl; unicode-bidi: isolate; text-align: center;">
                    ...
                    <div style="width: 100%; max-width: 100%; margin: 0 auto; display: block; direction: rtl; unicode-bidi: isolate; box-sizing: border-box;">
                        <table style="width: 100%; max-width: 100%; border-collapse: collapse; table-layout: fixed; direction: rtl; unicode-bidi: isolate; margin: 0 auto 12px auto; font-family: 'Vazir', 'Tahoma', sans-serif; box-sizing: border-box;">
                            <thead>
                                <tr style="direction: rtl; unicode-bidi: isolate;">
                                    <th style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; text-align: center; background-color: #e5e7eb; direction: rtl; unicode-bidi: isolate; vertical-align: middle; font-family: 'Vazir', 'Tahoma', sans-serif;">دسته‌بندی</th>
                                    <th style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; text-align: center; background-color: #e5e7eb; direction: rtl; unicode-bidi: isolate; vertical-align: middle; font-family: 'Vazir', 'Tahoma', sans-serif;">شرح هزینه / (ریال)</th>
                                    <th style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; text-align: center; background-color: #e5e7eb; direction: rtl; unicode-bidi: isolate; vertical-align: middle; font-family: 'Vazir', 'Tahoma', sans-serif;">مبلغ واحد / (ریال)</th>
                                    <th style="border: 1px solid #000; padding: 16px 16px 42px 16px; font-size: 13px; line-height: 1.5; text-align: center; background-color: #e5e7eb; direction: rtl; unicode-bidi: isolate; vertical-align: middle; font-family: 'Vazir', 'Tahoma', sans-serif;">مبلغ کل / (ریال)</th>
                                </tr>
                            </thead>
                            <tbody style="direction: rtl; unicode-bidi: isolate;">
                                ${tableRowsHTML}
    ...
    const exportInvoicesToImagesZipWithRealDOM = async (invoiceDataArray: Array<{
        ...
        try {
            ...
            for (let i = 0; i < invoiceDataArray.length; i++) {
                ...
                try {
                    // محاسبه تعداد ردیف‌ها برای تنظیم دینامیک عرض و فونت
                    const totalRows = invoiceData.blocks.reduce((sum, block) => 
                        sum + block.rows.filter(r => r.kind !== 'categoryHeader').length, 0
                    );
                    const tourCount = totalRows;
                    ...
                    // پیدا کردن invoice element
                    const invoiceElement = tempDiv.querySelector(`#invoice-real-dom-${i}`) as HTMLElement;
                    if (!invoiceElement) {
                        console.error(`❌ [REAL_DOM] invoice-real-dom-${i} پیدا نشد`);
                        document.body.removeChild(tempDiv);
                        continue;
                    }
                    ...
                    // انتظار برای render کامل و بارگذاری فونت
                    await new Promise(resolve => setTimeout(resolve, 1000));

                    // محاسبه ارتفاع دینامیک
                    const calculatedHeight = invoiceElement.scrollHeight || 2000;

                    // گرفتن تصویر با html2canvas با تنظیمات بهبود یافته
                    const canvas = await html2canvas(invoiceElement, {
                        scale: 1.5, // کیفیت خوب با حجم معقول
                        useCORS: true,
                        backgroundColor: '#ffffff',
                        allowTaint: true,
                        logging: false,
                        ...
                        onclone: (clonedDoc) => {
                            const clonedInvoice = clonedDoc.querySelector(`#invoice-real-dom-${i}`) as HTMLElement;
                            if (clonedInvoice) {
                                clonedInvoice.style.width = `${containerWidth}px`;
                                clonedInvoice.style.maxWidth = `${containerWidth}px`;
                                clonedInvoice.style.margin = '0 auto';
                    ...
                    // استفاده از JPEG برای کاهش حجم فایل
                    const imgData = canvas.toDataURL('image/jpeg', 0.9);
                    
                    // پاک کردن tempDiv قبل از پردازش تصویر
            ...
            alert(`فایل ZIP با ${successCount} تصویر با موفقیت تولید شد${failCount > 0 ? ` (${failCount} تصویر ناموفق)` : ''}`);
        } catch (error) {
    ...
    // ============================================================================
    // روش 3: استفاده از DOM واقعی + html2canvas پیشرفته - افقی (هر تور یک ردیف)
    // ============================================================================
    const exportInvoicesToImagesZipWithRealDOMHorizontal = async (invoiceDataArray: Array<{
        driverName?: string;
        employeeId?: string;
        accountNumber?: string;
        tourCount?: number;
        ...
        try {
            ...
            for (let i = 0; i < invoiceDataArray.length; i++) {
                ...
                try {
                    ...
                    // محاسبه عرض و فونت دینامیک - استفاده از عرض کامل صفحه
                    // برای html2canvas بهتر است از عرض ثابت استفاده کنیم که بعداً با scale تنظیم می‌شود
                    let containerWidth = 2100; // عرض بیشتر برای استفاده بهتر از فضا
                    let fontSize = 13;
                    let cellPadding = '14px 12px'; // padding بیشتر برای جلوگیری از برخورد به حاشیه
                    ...
                    const InvoiceComponent = () => {
                        ...
                        return (
                            <div 
                                id={`invoice-real-dom-horizontal-${i}`}
                                style={{
                                    direction: 'rtl',
                                    unicodeBidi: 'isolate',
                                    fontFamily: "'Vazir', 'Tahoma', sans-serif",
                            ...
                            >
                                ...
                                {/* جدول افقی - هر تور یک ردیف */}
                                <table style={{
                                    width: '100%',
                                    maxWidth: '100%',
                                    borderCollapse: 'collapse',
                                    tableLayout: 'fixed', // fixed برای کنترل بهتر عرض ستون‌ها
                                    direction: 'rtl',
                                    unicodeBidi: 'isolate',
                                    margin: '0 auto 12px auto',
                                    fontSize: `${fontSize}px`,
                    ...
                    if (!canvas || canvas.width === 0 || canvas.height === 0) {
                        console.error(`❌ [REAL_DOM_HORIZONTAL] Canvas خالی برای ${invoiceData.driverName}`);
                        document.body.removeChild(tempDiv);
                        failCount++;
                        continue;
                    }
            ...
            const zipUrl = URL.createObjectURL(zipBlob);
            const zipLink = document.createElement('a');
            zipLink.download = `صورتحساب_های_پرداخت_شده_افقی_${new Date().toISOString().split('T')[0]}.zip`;
            zipLink.href = zipUrl;
            zipLink.click();
            URL.revokeObjectURL(zipUrl);

            console.log(`✅ [REAL_DOM_HORIZONTAL] ZIP file generated: ${successCount} images`);
            alert(`فایل ZIP با ${successCount} تصویر با موفقیت تولید شد${failCount > 0 ? ` (${failCount} تصویر ناموفق)` : ''}`);
        } catch (error) {
            console.error('❌ [REAL_DOM_HORIZONTAL] خطا:', error);
            alert('خطا در تولید تصاویر. لطفاً دوباره تلاش کنید.');
        }
    };

    // ============================================================================
    // Wrapper function برای روش 2 (Real DOM - عمودی)
    // ============================================================================
    const exportAllInvoicesToImagesZipWithRealDOMWrapper = async () => {
        console.log('🖼️ [REAL_DOM] ========== شروع تولید ZIP تصاویر با Real DOM ==========');
        ...
        try {
            ...
            for (let i = 0; i < filteredRecords.length; i++) {
                ...
                console.log(`🖼️ [REAL_DOM] پردازش رکورد ${i + 1}/${filteredRecords.length}: ${record.driverName}`);
            ...
            if (invoiceDataArray.length === 0) {
                alert('هیچ داده‌ای برای تولید تصاویر یافت نشد.');
                return;
            }

            // فراخوانی تابع اصلی
            await exportInvoicesToImagesZipWithRealDOM(invoiceDataArray);
        } catch (error) {
            console.error('❌ [REAL_DOM] خطا:', error);
            alert('خطا در تولید تصاویر. لطفاً دوباره تلاش کنید.');
        }
    ...
    const exportAllInvoicesToImagesZipWithRealDOMHorizontalWrapper = async () => {
        ...
        try {
            ...
            for (let i = 0; i < filteredRecords.length; i++) {
                ...
                console.log(`🖼️ [REAL_DOM_HORIZONTAL] پردازش رکورد ${i + 1}/${filteredRecords.length}: ${record.driverName}`);
            ...
            // فراخوانی تابع اصلی
            await exportInvoicesToImagesZipWithRealDOMHorizontal(invoiceDataArray);
        } catch (error) {
            console.error('❌ [REAL_DOM_HORIZONTAL] خطا:', error);
            alert('خطا در تولید تصاویر. لطفاً دوباره تلاش کنید.');
        }
