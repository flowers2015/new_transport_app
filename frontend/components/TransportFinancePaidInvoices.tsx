            ...
            [...calculationsWithoutHelper, ...calculationsWithHelper].forEach((calc, idx) => {
                ...
                html += `
                    <tr style="border-bottom: 1px solid #cbd5e1;">
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(idx + 1).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${calc.bill_of_lading_number || calc.billOfLadingNumber || '-'}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: normal; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; box-sizing: border-box;">${destinations}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: normal; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; box-sizing: border-box;">${calc.bill_of_lading_date || calc.billOfLadingDate || '-'}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: normal; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; box-sizing: border-box;">${calc.calculation_date || calc.calculationDate || '-'}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${approvedKm.toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${excessKm.toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.approved_mission_days || calc.approvedMissionDays || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.excess_mission_days || calc.excessMissionDays || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.bill_of_lading_cost || calc.billOfLadingCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.food_cost || calc.foodCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.fuel_cost || calc.fuelCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.toll_cost || calc.tollCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.return_cargo_cost || calc.returnCargoCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.multi_unload_cost || calc.multiUnloadCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.excess_mission_cost || calc.excessMissionCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${depotShipmentCount.toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${depotMissionDays.toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${depotTotalMileage.toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${depotCargoHandling.toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${depotMissionCost.toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 12px 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${totalMileage.toLocaleString('fa-IR')}</td>
                        <td style="padding: 10px 12px 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${isFixedAllowance ? fixedAllowance.toLocaleString('fa-IR') : '-'}</td>
                        <td style="padding: 10px 12px 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${mainCost.toLocaleString('fa-IR')}</td>
                    </tr>
                `;
            });
            ...
            html += `
                            ...
                            <tfoot>
                                <tr style="background-color: #f1f5f9; font-weight: bold;">
                                    <td colspan="5" style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: normal; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; background-color: #f1f5f9; font-weight: bold; box-sizing: border-box;">جمع کل سراسری:</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.approved_kilometers || calc.approvedKilometers || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.excess_kilometers || calc.excessKilometers || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.approved_mission_days || calc.approvedMissionDays || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.excess_mission_days || calc.excessMissionDays || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.bill_of_lading_cost || calc.billOfLadingCost || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.food_cost || calc.foodCost || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.fuel_cost || calc.fuelCost || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.toll_cost || calc.tollCost || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.return_cargo_cost || calc.returnCargoCost || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.multi_unload_cost || calc.multiUnloadCost || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.excess_mission_cost || calc.excessMissionCost || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.depot_shipment_count || calc.depotShipmentCount || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.depot_mission_days || calc.depotMissionDays || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.depot_total_mileage || calc.depotTotalMileage || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.depot_cargo_handling_cost || calc.depotCargoHandlingCost || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => sum + (parseFloat(calc.depot_mission_cost || calc.depotMissionCost || 0)), 0).toLocaleString('fa-IR')}</td>
                                    <td style="padding: 10px 12px 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${calculations.reduce((sum, calc) => {
                                        const approvedKm = parseFloat(calc.approved_kilometers || calc.approvedKilometers || 0);
                                        const excessKm = parseFloat(calc.excess_kilometers || calc.excessKilometers || 0);
                                    ...
                                    <td style="padding: 10px 12px 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${totalMainAll.toLocaleString('fa-IR')} ریال</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
            ...
            if (helperData.calculations.length > 0) {
                ...
                helperData.calculations.forEach((calc, idx) => {
                    ...
                    html += `
                        <tr style="border-bottom: 1px solid #cbd5e1;">
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(idx + 1).toLocaleString('fa-IR')}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${helperEmployeeId}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: normal; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; box-sizing: border-box;">${helperData.name}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${calc.bill_of_lading_number || calc.billOfLadingNumber || '-'}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: normal; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; box-sizing: border-box;">${destinations}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: normal; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; box-sizing: border-box;">${calc.bill_of_lading_date || calc.billOfLadingDate || '-'}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: normal; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; box-sizing: border-box;">${calc.calculation_date || calc.calculationDate || '-'}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.approved_kilometers || calc.approvedKilometers || 0).toLocaleString('fa-IR')}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${helperExcessKm.toLocaleString('fa-IR')}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.approved_mission_days || calc.approvedMissionDays || 0).toLocaleString('fa-IR')}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.helper_driver_excess_mission_days || calc.helperDriverExcessMissionDays || 0).toLocaleString('fa-IR')}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.helper_driver_excess_mission_cost || calc.helperDriverExcessMissionCost || 0).toLocaleString('fa-IR')}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.helper_driver_food_cost || calc.helperDriverFoodCost || 0).toLocaleString('fa-IR')}</td>
                            <td style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${(calc.helper_driver_allowance || calc.helperDriverAllowance || 0).toLocaleString('fa-IR')}</td>
                            <td style="padding: 10px 12px 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${helperExcessKm.toLocaleString('fa-IR')}</td>
                            <td style="padding: 10px 12px 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; box-sizing: border-box;">${helperCost.toLocaleString('fa-IR')}</td>
                        </tr>
                    `;
                });
                ...
                html += `
                                ...
                                <tfoot>
                                    <tr style="background-color: #f1f5f9; font-weight: bold;">
                                        <td colspan="14" style="padding: 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: normal; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; background-color: #f1f5f9; font-weight: bold; box-sizing: border-box;">جمع کل:</td>
                                        <td style="padding: 10px 12px 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${helperTotalExcessKm.toLocaleString('fa-IR')}</td>
                                        <td style="padding: 10px 12px 10px 8px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box;">${helperTotal.toLocaleString('fa-IR')} ریال</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
