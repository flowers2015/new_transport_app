                            ...
                            if (clonedDiv) {
                                ...
                                clonedCells.forEach((cell) => {
                                    ...
                                    if (cellEl.tagName === 'TH' && rowSpan === '2') {
                                        ...
                                        cellEl.style.padding = isLastColumn ? '12px 18px 12px 12px' : '12px 12px';
                                        cellEl.style.fontSize = '11px';
            ...
            [...calculationsWithoutHelper, ...calculationsWithHelper].forEach((calc, idx) => {
                ...
                html += `
                    <tr style="border-bottom: 1px solid #cbd5e1;">
                        ...
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${approvedKm.toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${excessKm.toLocaleString('fa-IR')}</td>
                        ...
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${(calc.excess_mission_days || calc.excessMissionDays || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${(calc.bill_of_lading_cost || calc.billOfLadingCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${(calc.food_cost || calc.foodCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${(calc.fuel_cost || calc.fuelCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${(calc.toll_cost || calc.tollCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${(calc.return_cargo_cost || calc.returnCargoCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${(calc.multi_unload_cost || calc.multiUnloadCost || 0).toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${(calc.excess_mission_cost || calc.excessMissionCost || 0).toLocaleString('fa-IR')}</td>
                        ...
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${depotCargoHandling.toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${depotMissionCost.toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 18px 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${totalMileage.toLocaleString('fa-IR')}</td>
                        <td style="padding: 12px 18px 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${isFixedAllowance ? fixedAllowance.toLocaleString('fa-IR') : '-'}</td>
                        <td style="padding: 12px 18px 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; box-sizing: border-box; overflow: hidden;">${mainCost.toLocaleString('fa-IR')}</td>
                    </tr>
                `;
            });
            ...
            html += `
                            ...
                            <tfoot>
                                <tr style="background-color: #f1f5f9; font-weight: bold;">
                                    ...
                                    <td style="padding: 12px 18px 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box; overflow: hidden;">${calculations.reduce((sum, calc) => {
                                        const approvedKm = parseFloat(calc.approved_kilometers || calc.approvedKilometers || 0);
                                        const excessKm = parseFloat(calc.excess_kilometers || calc.excessKilometers || 0);
                                    ...
                                    <td style="padding: 12px 18px 12px 12px; border: 1px solid #cbd5e1; text-align: center; vertical-align: middle; font-size: 11px; font-weight: bold; white-space: nowrap; line-height: 1.6; background-color: #f1f5f9; box-sizing: border-box; overflow: hidden;">${totalMainAll.toLocaleString('fa-IR')} ریال</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
