    ...
    const fetchPeriodCalculations = async (period: any): Promise<Record<string, unknown>[]> => {
        ...
        try {
            ...
            return (data.tours || []).map((t: Record<string, unknown>) => ({
                ...
                tour_cost: t.tourCost,
                food_cost: t.foodCost,
                fuel_cost: t.fuelCost,
                toll_cost: t.tollCost,
                loading_cost: t.loadingCost,
                bill_of_lading_cost: t.billOfLadingCost,
                total_cost: t.totalCost,
                return_cargo_cost: t.returnCargoCost,
                return_inter_branch_cargo_cost: t.returnInterBranchCargoCost,
                return_bill_of_lading_cost: t.returnBillOfLadingCost,
                multi_unload_cost: t.multiUnloadCost,
                multi_unload_count: t.multiUnloadCount,
                excess_mission_cost: t.excessMissionCost,
                depot_cargo_handling_cost: t.depotCargoHandlingCost,
                depot_kilometer_rate: t.depotKilometerRate,
                depot_mission_cost: t.depotMissionCost,
                helper_driver_cost: t.helperDriverCost,
                helper_driver_id: t.helperDriverId,
                helper_driver_employee_id: t.helperDriverEmployeeId,
                helper_driver_name: t.helperDriverName,
                helper_driver_allowance: t.helperDriverAllowance,
                helper_driver_food_cost: t.helperDriverFoodCost,
                helper_driver_excess_mission_cost: t.helperDriverExcessMissionCost,
