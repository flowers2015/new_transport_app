...
const TransportLiveContainer: React.FC<{ currentUser: User }> = ({ currentUser }) => {
    ...
    const onUpdateAssignment = async (announcementId: string, assignment: any) => {
        ...
        setAnnouncements(prev => applyOptimisticUpdate(prev, announcementId, {
            ...
            helperDriverId: assignment.helperDriverId || undefined,
            helperDriverName: assignment.helperDriverName,
            helperDriverContact: assignment.helperDriverContact,
            helperDriverEmployeeId: assignment.helperDriverEmployeeId,
